    ...
    <div id="container">
        <div class="container Landscape initial">
            ...
            ?>
                ...
                <!-- <div class="container-items">
                    <img src="../folder parent/Autre/pexels-chait-goli-1918290.jpg" class="img">
                    <div class="container-download">
                        <button type="button" class="download fa fa-download">Télécharger</button>
                    </div>
                </div> -->
        ...
        <div class="container Cars transform">
            ...
            ?>
                ...
                <!-- <div class="container-items">
                    <img src="../folder parent/Autre/pexels-sebastiaan-stam-1097456.jpg" class="img">
                    <div class="container-download">
                        <button type="button" class="download fa fa-download">Télécharger</button>
                    </div>
                </div> -->
        ...
        <div class="container Towns transform">
            ...
            ?>
                ...
                <!-- <div class="container-items">
                    <img src="../folder parent/Ville/pexels-merlin-lightpainting-11167644.jpg" class="img">
                    <div class="container-download">
                        <button type="button" class="download fa fa-download">Télécharger</button>
                    </div>
                </div> -->
        ...
        <div class="container Other transform">
            ...
            ?>
                ...
                <!-- <div class="container-items">
                    <img src="../folder parent/Autre/pexels-ivan-siarbolin-3695799.jpg" class="img">
                    <div class="container-download">
                        <button type="button" class="download fa fa-download">Télécharger</button>
                    </div>
                </div> -->
